...
The root route lives in `src/routes/__root.tsx`. It owns the document shell, root error fallback, root not-found fallback, global CSS import, and router devtools.
